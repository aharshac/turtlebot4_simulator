...
def generate_launch_description():
    ...
    turtlebot4_node_launch = PathJoinSubstitution(
        [pkg_turtlebot4_gazebo_bringup, 'launch', 'turtlebot4_nodes.launch.py'])
    ...
    #     [pkg_turtlebot4_gazebo_bringup, 'launch', 'create3_ignition_nodes.launch.py'])
    ...
    param_file_cmd = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution(
            [pkg_turtlebot4_gazebo_bringup, 'config', 'turtlebot4_node.yaml']),
